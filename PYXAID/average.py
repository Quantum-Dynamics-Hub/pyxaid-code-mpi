...
#***********************************************************
# Parallelized by Dave Turner - Kansas State University - May 2018
# This contribution is distributed under the terms of the GNU General Public License
#***********************************************************
...
# Determine how many and what initial excitations are considered
    ...
    print "Number distinct initial excitations for myproc = ", len(my_dist_ex), my_dist_ex
   ...
   # and now use ms instead of MS, but only for the first part
    ...
    if opt==1 or opt==12:
        ...
        for in_ex in my_dist_ex:
            print "initial excitation = ", in_ex, " for myproc ", myproc
